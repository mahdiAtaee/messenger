    ...
    <div className={dark ? 'sidebar dark' : 'sidebar light'}>
      <ul>
        ...
        <li className={activePage === 'group' ? 'active item' : 'item'}>
          <Link to="/group" className="flex-center-between" onClick={() => setActivePage('group')}>
        ...
        <li className={activePage === 'settings' ? 'settings active item' : 'settings item'}>
          <NavLink to="/settings" onClick={() => setActivePage('settings')}>
        ...
        <li className="profile">
          <Link to="/settings" className="flex-center-between-column">
